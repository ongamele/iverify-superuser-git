      ...
      <Row>
        ...
        <Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              <Sparklines data={sampleData}>
                <SparklinesLine color="#009BD7" />
                <SparklinesReferenceLine type="mean" color="#009BD7 " />
              </Sparklines>
            </Card.Body>
          </Card>
        </Col>
        ...
        <Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              <Sparklines data={sampleData}>
                <SparklinesLine color="#009BD7" style={{ fill: "none" }} />
                <SparklinesSpots />
              </Sparklines>
            </Card.Body>
          </Card>
        ...
        <Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              <Sparklines data={sampleData}>
                <SparklinesLine color="#009BD7 " />
                <SparklinesSpots style={{ fill: "#009BD7 " }} />
              </Sparklines>
            </Card.Body>
          </Card>
        </Col>
        <Col xl={6} lg={6}>
          <Card>
            ...
            <Card.Body>
              <Sparklines data={sampleData}>
                <SparklinesBars
                  style={{ fill: "#009BD7", fillOpacity: ".6" }}
                />
                <SparklinesReferenceLine />
              </Sparklines>
            </Card.Body>
          ...
          <Card>
            ...
            <Card.Body>
              <Sparklines
                ...
                <SparklinesBars style={{ fill: "#009BD7" }} />
              </Sparklines>
            </Card.Body>
          </Card>
        </Col>
